...
import { Container } from 'src/app/(front-end)/_components/common/bottom-bar/styled'
import {
  IconChat,
  IconConfig,
  IconHome,
...
import {
  COLOR_BLACK,
  COLOR_GREY_E4E4E4,
} from 'src/app/(front-end)/_constants/color'
import { BOTTOM_ICON_SIZE } from 'src/app/(front-end)/_constants/size'
